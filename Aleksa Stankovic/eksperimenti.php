        ...
        <div class="card-body">
            ...
            <div class="col-md-12 text-center mb-3">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            Tabela sa eksperimentima
                        </div>
                        <div class="card-body">
                        <?php
                                // Iscitavanje podataka iz tabele eksperimenti
                                $upitEksperimenti = "SELECT * FROM eksperimenti";
                                $rezultatEksperimenti = mysqli_query($conn, $upitEksperimenti);

                                // Provera da li postoje podaci
                                if ($rezultatEksperimenti && mysqli_num_rows($rezultatEksperimenti) > 0) {
                                    ...
                                    echo "</thead>";
                                    echo "<tbody>";
                                    while ($red = mysqli_fetch_assoc($rezultatEksperimenti)) {
                                        echo "<tr>";
                                        echo "<td>" . $red['id'] . "</td>";
                                        echo "<td>" . $red['ime'] . "</td>";
                                        echo "<td>" . $red['opis'] . "</td>";
                                        echo "<td>" . $red['sredstva'] . "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";
                                    echo "</table>";
                                    ...
                                    echo "Nema podataka u tabeli eksperimenti.";
                                }
                            ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            Forma za dodavanje novih eksperimenata
                        </div>
                        <div class="card-body">
                            <form action="php/eksperimenti.php" method="POST">
                                <div class="mb-3">
                                    <label for="ime_eksperimenta" class="form-label">Ime eksperimenta</label>
                                    <input type="text" class="form-control" id="ime_eksperimenta" name="ime_eksperimenta">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="sredstva" class="form-label">Sredstva</label>
                                    <input type="text" class="form-control" id="sredstva" name="sredstva">
                                </div>
