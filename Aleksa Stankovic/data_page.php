        ...
        <div class="card-body">
            ...
            <div class="col-md-12 text-center mb-3">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            Tabela sa hemikalijama
                        </div>
                        <div class="card-body">
                        <?php
                                // Iscitavanje podataka iz tabele hemikalije
                                $upitHemikalije = "SELECT * FROM hemikalije";
                                $rezultatHemikalije = mysqli_query($conn, $upitHemikalije);

                                // Provera da li postoje podaci
                                if ($rezultatHemikalije && mysqli_num_rows($rezultatHemikalije) > 0) {
                                    ...
                                    echo "</thead>";
                                    echo "<tbody>";
                                    while ($red = mysqli_fetch_assoc($rezultatHemikalije)) {
                                        echo "<tr>";
                                        echo "<td>" . $red['id'] . "</td>";
                                        echo "<td>" . $red['ime'] . "</td>";
                                        echo "<td>" . $red['opis'] . "</td>";
                                        echo "<td>" . $red['svojstva'] . "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";
                                    echo "</table>";
                                    ...
                                    echo "Nema podataka u tabeli hemikalije.";
                                }
                            ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            Forma za dodavanje novih hemikalija
                        </div>
                        <div class="card-body">
                            <form action="php/hemikalije.php" method="POST">
                                <div class="mb-3">
                                    <label for="ime_hemikalije" class="form-label">Ime hemikalije</label>
                                    <input type="text" class="form-control" id="ime_hemikalije" name="ime_hemikalije">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="svojstvo" class="form-label">Svojstvo</label>
                                    <input type="text" class="form-control" id="svojstvo" name="svojstvo">
                                </div>
